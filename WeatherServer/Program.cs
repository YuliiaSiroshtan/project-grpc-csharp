...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(x =>
{
    var key = Encoding.UTF8.GetBytes(
        "So either use another (symmetric) signature algorithm (and ensure that your key size is valid for this algorithm)");
    ...
    x.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        IssuerSigningKey = new SymmetricSecurityKey(Convert.FromBase64String(
            "gTHIcLUuAMu/j5JHaN4WjRD7LABfDtT4iYCFzGJ6b2dHCkx9o4WOlPH8PP3vnKZWQ1YhoDF4A/GcuqTfK0hor/2jQyrtP2RM55bciN8/fONfBJBuvsuV8N1gxX+3mxbS")),
